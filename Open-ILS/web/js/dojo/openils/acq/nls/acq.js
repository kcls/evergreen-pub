{
    ...
    "LINEITEM_SUMMARY" : "<div class='acq-lineitem-summary'><a target='_blank' href='${19}?focus_li=${10}&source=${22}'>${0}</a>, by ${1} (${2})</div>\n<div class='acq-lineitem-summary-extra'>\n${3} Ordered, ${4} Received, ${7} Invoiced, ${8} Claimed, ${9} Cancelled, ${23} Delayed</div>\n<div class='acq-lineitem-summary-extra'>Estimated $${6}, Encumbered $${16}, Paid $${17}</div>\n<div class='acq-lineitem-summary-extra'>\n# <a target='_blank' href='/eg2/staff/acq/related/${24}'>${10}</a> <a target='_top' style='padding-right: 10px;' class='hidden${20}'  href='/eg2/staff/acq/po/${12}?focus_li=${10}&source=${22}'>&#x2318; ${13} ${18}</a>\n<a target='_top' style='padding-right: 10px;' class='hidden${21}' href='/eg2/staff/acq/picklist/${14}?focusLi=${10}&source=${22}'>&#x2756; ${15}</a></div>",
    ...
    "INVOICE_ITEM_PO_DETAILS" : "<b>${0}</b><br/><a target='_top' href='/eg2/staff/acq/po/${2}'>PO #${3} ${4}</a><br/>Total Estimated Cost: $${5}",
    "INVOICE_ITEM_PO_LABEL" : "<a target='_top' href='/eg2/staff/acq/po/${1}'>PO #${2} ${3}</a><br/>Total Estimated Cost: $${4}",
    "UNNAMED" : "Unnamed",
