...
STANDALONE_BATCH_SIZE=${STANDALONE_BATCH_SIZE:-5000}
STANDALONE_MAX=${STANDALONE_MAX:-100000}
...
# Once we've aged all of the standalone transits -- no prev_hop chain -- uncomment
# this version which operates on transit chains.  Note this version is slower
# so we need to wait and turn it on after the transit table has reached 
